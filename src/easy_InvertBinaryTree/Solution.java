package easy_InvertBinaryTree;
import easy_BinaryTreeDepth.TreeNode;
...
public class Solution {
	...
	public static void main(String [] args){
		...
		node4.left=node9; node4.right=node10;
		node5.left=node11; node5.right=node12;
		node6.left=node13; node6.right=node14;
		node7.left=node15; node7.right=node16;
		node8.left=node17; node8.right=node18;
		node9.left=node19; node9.right=node20;
		node10.left=node21; node10.right=node22;
		node11.left=node23; node11.right=node24;
		node12.left=node25; node12.right=node26;
		node13.left=node27; node13.right=node28;
		node14.left=node29; node14.right=node30;
		node15.left=node31; node15.right=node32;
		node16.left=node33; node16.right=node34;
		node17.left=node35; node17.right=node36;
		node18.left=node37; node18.right=node38;
		node19.left=node39; node19.left=node40; 
		System.out.println(node19.left);
		System.out.println(node19.right);
